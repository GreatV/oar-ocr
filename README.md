...
PaddleOCR-VL variants, GLM-OCR, NaviDC-OCR, and jina-ocr-v1 integrate with the external-layout [`DocParser`](oar-ocr-vl/README.md#document-parsing-pipeline). OvisOCR2, HPD-Parsing, and the MonkeyOCRv2 S/B parsing models instead provide model-native full-page paths through dedicated examples. HunyuanOCR and the MinerU models also use their model-native parsing pipelines.
